...
- **🗺️ Risk Map**: New `.gitcore/risk-map.json` configuration to define risk scores per file path.
...
- **Features Tracking**: New `.gitcore/features.json` template for tracking feature status.
...
- **Required Files**: Projects using v3.0 should create `.gitcore/features.json` for Planner Agent.
